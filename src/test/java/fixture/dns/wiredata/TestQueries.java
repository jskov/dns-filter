...
public class TestQueries {
	...
	* 0x0000 90 af 01 00 00 01 00 00  00 00 00 01 04 69 6d 67 .............img
	* 0x0010 73 04 78 6b 63 64 03 63  6f 6d 00 00 01 00 01 00 s.xkcd.com......
	* 0x0020 00 29 10 00 00 00 00 00  00 00                   .)........
	 */
	public static final byte[] IMGS_XKCD_COM = new byte[] {(byte)0x90, (byte)0xaf, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x04, 0x69, 0x6d, 0x67, 0x73, 0x04, 0x78, 0x6b, 0x63, 0x64, 0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x29, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, };

	/* Reply for imgs.xkcd.com
	* 0x0000 90 af 81 80 00 01 00 02  00 00 00 01 04 69 6d 67 .............img
	* 0x0010 73 04 78 6b 63 64 03 63  6f 6d 00 00 01 00 01 c0 s.xkcd.com......
	* 0x0020 0c 00 05 00 01 00 00 0a  4a 00 23 09 64 75 61 6c ........J.#.dual
	...
	* 0x0050 00 01 00 01 00 00 00 1e  00 04 c7 e8 28 43 00 00 ............(C..
	...
	* ;; flags: qr rd ra; QUERY: 1, ANSWER: 2, AUTHORITY: 0, ADDITIONAL: 1
	* ;; WARNING: Message has 407 extra bytes at end
	* 
	* ;; OPT PSEUDOSECTION:
	* ; EDNS: version: 0, flags:; udp: 1452
	* ;; QUESTION SECTION:
	...
	* 
	* ;; ANSWER SECTION:
	* imgs.xkcd.com.		2634	IN	CNAME	dualstack.i.ssl.global.fastly.net.
	* dualstack.i.ssl.global.fastly.net. 30 IN A	199.232.40.67
	*/
	public static final byte[] IMGS_XKCD_COM_REPLY = new byte[] {(byte)0x90, (byte)0xaf, (byte)0x81, (byte)0x80, 0x00, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x04, 0x69, 0x6d, 0x67, 0x73, 0x04, 0x78, 0x6b, 0x63, 0x64, 0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01, (byte)0xc0, 0x0c, 0x00, 0x05, 0x00, 0x01, 0x00, 0x00, 0x0a, 0x4a, 0x00, 0x23, 0x09, 0x64, 0x75, 0x61, 0x6c, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x01, 0x69, 0x03, 0x73, 0x73, 0x6c, 0x06, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x06, 0x66, 0x61, 0x73, 0x74, 0x6c, 0x79, 0x03, 0x6e, 0x65, 0x74, 0x00, (byte)0xc0, 0x2b, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x1e, 0x00, 0x04, (byte)0xc7, (byte)0xe8, 0x28, 0x43, 0x00, 0x00, 0x29, 0x05, (byte)0xac, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, };
