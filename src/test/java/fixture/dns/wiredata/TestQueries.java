 ...
 * or by calling makeExternalLoggingRequest() to capture data
...
public class TestQueries {
	...
	* 0x0080 65 c1 8c 00 00 29 04 d0  00 00 00 00 00 00       e....)........
	...
	/* Bad handling: Unhandled type class dk.mada.dns.wire.model.DnsRecord
	* 0x0000 55 4d 01 00 00 01 00 00  00 00 00 00 05 73 74 6f UM...........sto
	* 0x0010 72 65 09 65 61 73 79 62  72 61 69 6e 03 63 6f 6d re.easybrain.com
	* 0x0020 00 00 41 00 01                                  ..A..
	 */
	public static final byte[] STORE_EASYBRAIN_REQUEST = new byte[] {0x55, 0x4d, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x09, 0x65, 0x61, 0x73, 0x79, 0x62, 0x72, 0x61, 0x69, 0x6e, 0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x41, 0x00, 0x01, };

	/* Unknown reply record
	* 0x0000 55 4d 81 80 00 01 00 01  00 00 00 00 05 73 74 6f UM...........sto
	* 0x0010 72 65 09 65 61 73 79 62  72 61 69 6e 03 63 6f 6d re.easybrain.com
	* 0x0020 00 00 41 00 01 c0 0c 00  41 00 01 00 00 00 8d 00 ..A.....A.......
	* 0x0030 28 00 01 00 00 01 00 15  05 68 33 2d 32 39 05 68 (........h3-29.h
	* 0x0040 33 2d 32 38 05 68 33 2d  32 37 02 68 32 00 04 00 3-28.h3-27.h2...
	* 0x0050 08 68 12 04 d8 68 12 05  d8                      .h...h...
	 */
	public static final byte[] STORE_EASYBRAIN_REPLY = new byte[] {0x55, 0x4d, (byte)0x81, (byte)0x80, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x05, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x09, 0x65, 0x61, 0x73, 0x79, 0x62, 0x72, 0x61, 0x69, 0x6e, 0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x41, 0x00, 0x01, (byte)0xc0, 0x0c, 0x00, 0x41, 0x00, 0x01, 0x00, 0x00, 0x00, (byte)0x8d, 0x00, 0x28, 0x00, 0x01, 0x00, 0x00, 0x01, 0x00, 0x15, 0x05, 0x68, 0x33, 0x2d, 0x32, 0x39, 0x05, 0x68, 0x33, 0x2d, 0x32, 0x38, 0x05, 0x68, 0x33, 0x2d, 0x32, 0x37, 0x02, 0x68, 0x32, 0x00, 0x04, 0x00, 0x08, 0x68, 0x12, 0x04, (byte)0xd8, 0x68, 0x12, 0x05, (byte)0xd8, };

	
	/**
	 * Use this if you need to capture a real reply to a canned query.
	 */
	public static Resolver makeExternalLoggingResolver() {
